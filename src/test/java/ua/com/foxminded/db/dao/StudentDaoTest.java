...
class StudentDaoTest {
    ...
    private Integer createStudent(String expectedFirstName, String expectedLastName) throws SQLException {
        try (Connection connection = DataSource.getConnection()) {
            PreparedStatement preparedStatement =
    ...
    private Integer createGroup(String expectedGroupName, int expectedGroupAmountStudents) throws SQLException {
        try (Connection connection = DataSource.getConnection()) {
    ...
    private Integer createCourse(String expectedCourseName, String expectedCourseDescription) throws SQLException {
        try (Connection connection = DataSource.getConnection()) {
